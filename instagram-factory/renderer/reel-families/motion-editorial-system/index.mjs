...
export function renderScenes(reel, assets = {}) {
  return reel.scenes.map((scene) => {
    ...
    if (scene.id === 'scene-06') return sceneSix(scene, reel, assets);
...
function coverEditorial(reel) {
  ...
  return `<section class="reel-cover" data-color>
    ${grid()}
    ${contentNode(reel.cover.text[0], 'reel-cover-title display-serif', title)}
    ${contentNode(reel.cover.text[1], 'reel-cover-tools text-sans')}
    <div class="cover-cycle" data-color aria-hidden="true">
      <i class="cover-cycle-line cover-cycle-line-top"></i>
      <i class="cover-cycle-line cover-cycle-line-right"></i>
      <i class="cover-cycle-line cover-cycle-line-bottom"></i>
      <i class="cover-cycle-line cover-cycle-line-left"></i>
      <b class="cover-ok cover-ok-1"></b>
      <b class="cover-ok cover-ok-2"></b>
      <b class="cover-ok cover-ok-3"></b>
      <b class="cover-ok cover-ok-4"></b>
    </div>
  </section>`;
}
