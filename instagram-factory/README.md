...
Сначала отработать контент-завод на личном Instagram Александра Смолея: найти модель, в которой хороший контент можно выпускать много, удобно и предсказуемо, а участие автора постепенно сводится к нескольким содержательным подтверждениям/«ОК».

После доказательства модели — упаковать процесс как услугу внедрения и поддержки контент-заводов для брендов.
